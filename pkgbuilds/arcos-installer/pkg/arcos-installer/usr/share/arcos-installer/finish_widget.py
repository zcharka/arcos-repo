...
# --- i18n Setup ---
WIDGET_NAME = "arcos-installer-finish-widget"
...
class FinishWidget(Gtk.Box):
    def __init__(self, **kwargs):
        ...
        self.subtitle_label.set_markup(f'<span size="large">{localization_manager.get_text("Everything is set up for you. Thank you for choosing ArcOS.\nReboot the system to finish installation.")}</span>')
...
class FinishApp(Adw.Application):
    def __init__(self):
        super().__init__(application_id="com.arcos.installer.finish")
