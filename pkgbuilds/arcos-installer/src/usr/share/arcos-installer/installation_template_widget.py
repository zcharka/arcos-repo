...
class InstallationTemplateWidget(Gtk.Box):
    ...
    def __init__(self, **kwargs):
        ...
        self.subtitle.set_markup('<span size="11500">{}</span>'.format(_("The selected partition will be replaced with ArcOS.")))
    ...
    def on_advanced_setup_clicked(self, button=None):
        ...
        fs_group.set_description(_("Filesystem for the partition ArcOS is installed on. "
    ...
    def _apply_compact_layout(self):
        ...
        self.subtitle.set_markup('<span size="10000">{}</span>'.format(_(
            "The selected partition will be replaced with ArcOS.")))
