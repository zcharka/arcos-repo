translations = {
            ...
            "Everything is set up for you. Thank you for choosing ArcOS.": "Tudo está configurado para você. Obrigado por escolher ArcOS.",
            "Reboot the system to finish installation.": "Reinicie o sistema para finalizar a instalação.",
            "Everything is set up for you. Thank you for choosing ArcOS.\nReboot the system to finish installation.": "Tudo está configurado para você. Obrigado por escolher ArcOS.\nReinicie o sistema para finalizar a instalação.",
            "Reboot": "Reiniciar",
            ...
            "The selected partition will be replaced with ArcOS.": "A partição selecionada será substituída pelo ArcOS.",
    ...
    "Download ArcOS-suggested Flatpaks": "Baixar Flatpaks sugeridos pelo ArcOS",
    ...
    "Filesystem for the partition ArcOS is installed on. ext4 is the reliable default. Btrfs adds transparent compression and snapshot-capable subvolumes (@ for / and @home for /home).": "Sistema de arquivos da partição onde o ArcOS é instalado. ext4 é o padrão confiável. O Btrfs adiciona compactação transparente e subvolumes compatíveis com instantâneos (@ para / e @home para /home).",
    "Swap": "Swap",
