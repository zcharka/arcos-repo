translations = {
            ...
            "The selected partition will be replaced with ArcOS.": "Выбранный раздел будет заменен на ArcOS.",
            ...
            "ArcOS (Current One)": "ArcOS (Текущий)",
    ...
    "Download ArcOS-suggested Flatpaks": "Загрузить рекомендованные ArcOS Flatpak-пакеты",
    ...
    "Filesystem for the partition ArcOS is installed on. ext4 is the reliable default. Btrfs adds transparent compression and snapshot-capable subvolumes (@ for / and @home for /home).": "Файловая система для раздела, на который устанавливается ArcOS. ext4 — надёжный вариант по умолчанию. Btrfs добавляет прозрачное сжатие и подтома с поддержкой снимков (@ для / и @home для /home).",
    "Swap": "Подкачка",
