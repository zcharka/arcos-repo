translations = {
            ...
            "Everything is set up for you. Thank you for choosing ArcOS.": "一切都已为您设置好。感谢您选择 ArcOS。",
            "Reboot the system to finish installation.": "重新启动系统以完成安装。",
            "Everything is set up for you. Thank you for choosing ArcOS.\nReboot the system to finish installation.": "一切都已为您设置好。感谢您选择 ArcOS。\n重新启动系统以完成安装。",
            "Reboot": "重新启动",
            ...
            "The selected partition will be replaced with ArcOS.": "选定的分区将被 ArcOS 替换。",
    ...
    "Download ArcOS-suggested Flatpaks": "下载 ArcOS 推荐的 Flatpak 应用",
    ...
    "Filesystem for the partition ArcOS is installed on. ext4 is the reliable default. Btrfs adds transparent compression and snapshot-capable subvolumes (@ for / and @home for /home).": "安装 ArcOS 的分区所用的文件系统。ext4 是可靠的默认选项。Btrfs 提供透明压缩和支持快照的子卷（@ 对应 /，@home 对应 /home）。",
    "Swap": "交换空间",
    "Swap File": "交换文件",
